      ...
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_360px]" id="summary">
        ...
        <Card>
          ...
          <CardContent className="grid gap-4">
            ...
            <form action={permanentlyDeleteArchiveAction} className="grid gap-2 rounded-md border border-danger/30 bg-danger-soft p-3">
              {hiddenArchiveId(record.id)}
              <button
                className={buttonClassName({ variant: "destructive", size: "sm" })}
