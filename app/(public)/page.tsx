  ...
  <div className="relative mx-auto flex min-h-[100svh] w-full max-w-7xl items-center px-5 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
    <div className="w-full max-w-3xl">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-x-3 gap-y-2 text-sm text-white/80">
        <span>Already working with IFTA?</span>
        <Link className="font-bold text-brand-mist underline decoration-brand-mist/50 underline-offset-4 hover:text-white" href="/client-portal">
